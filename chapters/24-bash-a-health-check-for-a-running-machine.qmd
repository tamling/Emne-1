...
{"type":"order","title":"Try it: the four morning questions","instr":"Tap the questions in the order the chapter asks them - each answer narrows the next.","steps":["Is the service running?","How full is the disk?","What is listening?","What do the logs say?"],"ok":"Service, disk, ports, logs - every morning.","why":"A stopped service explains most complaints, and each answer narrows the next: disk, then ports, then logs.","ref":"Part 1 of this chapter"}
</script>
```
...
```{=html}
<script type="application/json" class="qex">
{"type":"quiz","title":"Check yourself","q":"A colleague asks how long the disk will last. Which df column do you quote?","options":["Avail - the space left, in real units","Use% - the percentage everyone reads","Size - how big the filesystem is","Mounted on - where the filesystem sits"],"correct":[0],"ok":"Right.","why":"The percentage hides the size: 92 percent of forty gigabytes leaves three, and 92 percent of four terabytes leaves three hundred and twenty.","ref":"Part 3 of this chapter"}
</script>
```
...
```{=html}
<script type="application/json" class="qex">
{"type":"match","title":"Try it: narrow the journal","instr":"The journal is far too long to read from the top. Drag each flag onto the dimension it narrows. Two flags are distractors.","zones":[{"label":"One unit, such as ssh","answer":"-u"},{"label":"Messages at or above a priority","answer":"-p"},{"label":"A start time, such as -1h","answer":"-S"}],"extra":["-q","-h"],"ok":"Unit, priority and time - and the flags combine.","why":"-u narrows to one unit, -p to a priority and -S to a start time; the flags combine.","ref":"Part 4 of this chapter"}
</script>
```
