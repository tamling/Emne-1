...
(function () {
  ...
  function check() {
    ...
    if (wrong.length === 0) {
      solved = true;
      setMsg('✓ Correct - confidentiality, integrity and availability form the CIA triad. Authenticity supports all three but is not one of its corners.', 'ok');
      return;
    }
  ...
  solBtn.addEventListener('click', function () {
    ...
    setMsg('Solution shown - the triad is confidentiality, integrity and availability. Hit Reset to try it properly.', 'ok');
  });
  reset();
})();
</script>
