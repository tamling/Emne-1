...
```{=html}
<script type="application/json" class="qex">
{"type":"quiz","title":"Check yourself","q":"Why does ip_address(\"999.999.999.999\") fail where a pattern of four numbers with dots would not?","options":["The module knows no such address can exist","The string is too long for a pattern to read","Numbers above 255 crash every pattern","The module accepts only private addresses"],"correct":[0],"ok":"Right.","why":"The difference is between something shaped like an address and something that is one; the module raises ValueError."}
</script>
```
