...
```{=html}
<script type="application/json" class="qex">
{"type": "match", "title": "Try it: three devices, three questions", "instr": "Drag each device onto the question it asks about every packet. Two terms are not middle devices and stay on the bench.", "zones": [{"label": "Which port does this go out of?", "answer": "Switch"}, {"label": "Which network is this handed to next?", "answer": "Router"}, {"label": "Is this allowed at all?", "answer": "Firewall"}], "extra": ["Host", "Wireshark"], "ok": "Right. And only the firewall's answer comes from rules a person wrote down."}
</script>
```
