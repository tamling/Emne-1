...
```{=html}
<script type="application/json" class="qex">
{"type":"quiz","title":"Check yourself","q":"The script reported 21 events written, and wc -l counts 22 lines in the file. What does that mean?","options":["The check passes: the header row is a line as well","One event was silently dropped","wc -l counted a blank line by mistake","The file was opened in append mode"],"correct":[0],"ok":"Right.","why":"Two numbers differing by exactly one is the check passing; any other difference is the check failing."}
</script>
```
