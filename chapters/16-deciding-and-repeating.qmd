...
```{=html}
<script type="application/json" class="qex">
{"type":"match","title":"Try it: the loop words","instr":"Drag each word onto the job the chapter gives it. Two are distractors and stay on the bench.","zones":[{"label":"Once per item in a sequence","answer":"for"},{"label":"While a condition stays true","answer":"while"},{"label":"Skip the rest of this pass","answer":"continue"},{"label":"Leave the loop entirely","answer":"break"}],"extra":["range","elif"],"ok":"That is the vocabulary of repetition."}
</script>
```
