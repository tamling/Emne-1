...
```{=html}
<script type="application/json" class="qex">
{"type": "quiz", "title": "Check yourself", "q": "Which of the three February assessments is published by Politiets sikkerhetstjeneste (PST)?", "options": ["Nasjonal trusselvurdering", "Fokus", "Risiko", "All three of them"], "correct": [0], "ok": "Right.", "why": "PST looks inwards with Nasjonal trusselvurdering. Fokus is Etterretningstjenesten looking outwards, and Risiko is NSM on how well protection works in practice."}
</script>
```
