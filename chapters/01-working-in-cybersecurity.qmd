...
.cia-widget .cia-reset { display: block; margin: .5rem auto 0; font-size: .8rem; padding: .25rem .9rem; border: 1px solid #8d99ae; border-radius: 4px; background: transparent; color: inherit; cursor: pointer; }
