...
```{=html}
<script type="application/json" class="qex">
{"type":"quiz","title":"Check yourself","q":"The red backup row should become orange instead. Which rule in the stylesheet changes?","options":[".varsel","th","body",".ingress","h1"],"correct":[0],"ok":"Right.","why":"A class selector starts with a dot and matches the class attribute; .varsel is the rule on the backup cell, and one line changes it everywhere."}
</script>
```
...
```{=html}
<script type="application/json" class="qex">
{"type":"quiz","title":"Check yourself","q":"One JavaScript file loaded by a payment page is edited to copy card data as it is typed. What does the visitor notice?","options":["Nothing - the page works and the padlock looks the same","The padlock disappears from the address bar","The browser warns that a loaded file has changed","The payment fails, which reveals the attack"],"correct":[0],"ok":"Right.","why":"HTTPS protects data in transit, not from code running inside the page. The padlock is identical on a clean page and an edited one."}
</script>
```
