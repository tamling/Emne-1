...
```{=html}
<script type="application/json" class="qex">
{"type":"buckets","title":"Try it: readlines or line by line?","instr":"Sort each fact onto the way of reading it describes.","buckets":["readlines()","for linje in f"],"items":[["All lines into memory at once",0],["One line at a time",1],["Handles a 4 GB log",1],["A list where each item is one line",0]],"ok":"A 69-line log fits either way, and a 4 GB log does not."}
</script>
```
