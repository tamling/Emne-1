...
```{=html}
<script type="application/json" class="qex">
{"type":"match","title":"Try it: the protected replacement","instr":"Drag each protected protocol onto the job and old protocol it replaces. Two are distractors.","zones":[{"label":"Moves files - FTP on 21","answer":"SFTP on 22"},{"label":"Command line elsewhere - telnet on 23","answer":"SSH on 22"},{"label":"Fetches a web page - HTTP on 80","answer":"HTTPS on 443"},{"label":"Mail between servers - SMTP on 25","answer":"Mail submission on 587"}],"extra":["FTPS on 21","DNS on 53"],"ok":"The old member of each pair carries your password readably."}
</script>
```
...
```{=html}
<script type="application/json" class="qex">
{"type":"order","title":"Try it: three questions about a service","instr":"Tap the chapter's three questions in the order you ask them.","steps":["Is it running?","Who can reach it?","Does it need to be there, and who says so?"],"ok":"The first two describe; only the third removes work."}
</script>
```
...
```{=html}
<script type="application/json" class="qex">
{"type":"quiz","title":"Check yourself","q":"What did every machine WannaCry reached have in common?","options":["A service reachable on a port plus a patch nobody had applied","A weak administrator password","An FTP server sending passwords readably","No antivirus software installed","A forgotten test service on port 8080"],"correct":[0],"ok":"Right.","why":"Windows file sharing over SMB was reachable on port 445, and Microsoft had published the patch on 14 March 2017 - two months before the attack."}
</script>
```
